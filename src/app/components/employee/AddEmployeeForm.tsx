...
export default function AddEmployeeForm({ onClose }: { onClose: () => void }) {
  const [formData, setFormData] = useState({
    firstName: "", lastName: "", companyName: "", teamName: "", country: "",
    mobile: "", alternateContact: "", email: "", pinCode: "", city: "",
    username: "", userEmail: "", password: "", repeatPassword: "", userRole: "", linkedinId: ""
  });
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-500/40 z-50">
      <div className="bg-white rounded-lg shadow-lg relative max-w-3xl w-full max-h-[80vh]">
        ...
        <div className="p-6 h-[80vh] overflow-y-auto">
          ...
          {inputField("Company Name", "companyName", "", "text")}
          {inputField("Team Name", "teamName", "", "text")}
